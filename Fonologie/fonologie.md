...
`/a/`, `/e/`, `/i/`, `/ɔ/`, `/u/`; psány `a`, `e`, `i`, `o`, `u`

## Souhlásky

`/m/`, `/n/`, `/p/`, `/t/`, `/c/`, `/k/`, `/f/`, `/s/`, `/ʃ/`, `/x/`, `/l/`, `/ʎ/`; psány `m`, `n`, `p`, `t`, `c`, `k`, `f`, `s`, `z`, `x`, `l`, `j`.

Nerozlišuje se znělost souhlásek při určování významu, znělost se dá použít na kladení důrazu.
...
{#TODO jaká by měla být fonologická struktura morfémů#}